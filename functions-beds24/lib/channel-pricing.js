...
// imports). Required by ./index.js's beds24OutboundWorker for the
// job_intent 'channel_rate' branch: CHANNEL_PRICING_RULES (to look up the
// requesting channel's price slot / calculation rule) and, via
// beds24-bridge.js's buildChannelRateDifferentialPayload, computeChannelRateForDate.
//
...
// "live overrides the bundled default" read (canonicalRates() in
// ./index.js, mirroring roomTypeConfig()'s own existing pattern) lives in
