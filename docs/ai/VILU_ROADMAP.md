...
**Status:** COMPLETE, 2026-09-06 (pre-production, awaiting owner review) · **Owner approval required:** NO (content plan) — YES already given for production deploy of this specific change, not yet exercised · **Production impact:** none yet — not deployed to hosting this pass
...
**Status:** COMPLETE, 2026-09-06 (pre-production, awaiting owner review) · **Owner approval required:** NO (content) — operational facts (IMUGA, VAM airport code/dates, flight/speedboat durations) verified live this pass · **Production impact:** none yet — not deployed to hosting this pass
