...
## Search intelligence / research discipline (Phase 23, added 2026-09-06)

- **A genuine, separate, live legacy website was found at `viluresidence.com`** (not the canonical `.net`), using the same phone number, address, and email as the real business, with a real guest testimonial and a 2024 copyright footer. It was not modified, redirected, or otherwise acted on — only reported (`COMPETITOR_GAPS.md` §3). Any decision about it (redirect, retire, update, claim ownership) belongs to the owner.
